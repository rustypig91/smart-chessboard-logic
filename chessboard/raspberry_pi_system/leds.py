...
from chessboard.events import event_manager, SetSquareColorEvent
...
class _BoardLeds:
    ...
    def __init__(self) -> None:
        ...
        event_manager.subscribe(
            SetSquareColorEvent, self._handle_set_square_color_event)
    ...
    def _handle_set_square_color_event(self, event: SetSquareColorEvent):
